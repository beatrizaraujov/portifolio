      ...
      <div className="lg:col-span-6 space-y-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-lg leading-relaxed font-medium">
            Atuo conectando produto, design e desenvolvimento. Meu foco é garantir
            que decisões técnicas não prejudiquem a experiência do usuário nem os
        ...
        <div className="space-y-10 border-l border-white/10 pl-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed max-w-sm">
              Validação de viabilidade técnica, ajustes de interface e colaboração
              para manter consistência entre design e implementação.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed max-w-sm">
              Tradução de requisitos em soluções técnicas claras, considerando
              impacto, prazo e manutenção.
            </p>
          </div>
